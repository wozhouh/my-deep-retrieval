...
class CoverDataset:
    def __init__(self, cls_file, root_dir, L):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cls_file', type=str, required=False, help='file path to the txt')
    parser.add_argument('--root_dir', type=str, required=False, help='file path to the txt')
    parser.set_defaults(cls_file='/home/processyuan/data/cover/demo_shortv.txt')
